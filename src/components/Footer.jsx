...
const Footer = () => {
  return (
    <div className="mx-4 mt-5 p-5 footer">
      ...
      <section className="d-flex justify-content-between mb-5">
        ...
        <nav>
          <ul className="d-flex gap-4 me-5">
            <li>
              <Link to="https://www.instagram.com/thebodyshop/" target="_blank">
                <svg
            ...
            <li>
              <Link
                to="https://www.facebook.com/TheBodyShopGeo/?brand_redir=170490307980"
                target="_blank"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <li>
              <Link to="https://www.tiktok.com/@thebodyshopuk" target="_blank">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 34 34"
                  style={{ width: "22px", height: "22px" }}
            ...
            <li>
              <Link to="https://x.com/thebodyshop?lang=en" target="_blank">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <li>
              <Link
                to="https://uk.pinterest.com/thebodyshopuk/"
                target="_blank"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <li>
              <Link
                to="https://www.youtube.com/user/thebodyshopuk"
                target="_blank"
              >
                {" "}
                <svg
