...
const SerumsAndEssences = () => {
  const serumsAndEssences = useLoaderData();

  const category = "serums & essences";
  ...
  return (
    <div className="p-3">
      ...
      >
        <Await resolve={serumsAndEssences.data}>
          {(resolvedData) => (
...
export default SerumsAndEssences;
