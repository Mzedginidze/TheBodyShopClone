...
const BodyMoisturisers = () => {
  const bodyMoisturisers = useLoaderData();

  const category = "body moisturisers";
  ...
  return (
    <div className="p-3">
      ...
      >
        <Await resolve={bodyMoisturisers.data}>
          {(resolvedData) => (
...
export default BodyMoisturisers;
